...
{/* All Admins Details Here*/}
          ...
          <div className="col-md-12">
              <div className="card">
                ...
                <h3 >All Admins <span className="float-right"> <button className="btn btn-primary" onClick={() => {window.location.reload();}}>Refresh</button> </span></h3> 
                </div>
                        ...
                        <tr key={user.id}>
                          ...
                          <td>
                            ...
                            <td>
                                <button
                                    className="btn btn-primary"
                                    onClick={() => React.updateElement(user,"user")}
                                >
                                    To User
                                </button>
                            </td>
